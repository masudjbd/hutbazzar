...
<link rel="stylesheet" href="<spring:url value="resource/css/bootstrap.min.css" />" >
	...
	<section class="container">
		...
		<form:form modelAttribute="order.customer" class="form-horizontal">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="phoneNumber" />Phone
					Number</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="doorNo" />Door
					No</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="streetName" />Street
					Name</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="areaName" />Area
					Name</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="zipCode" />Zip
					Code</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<input type="submit" id="btnAdd" class="btn btn-primary"
							value="Add Customer Details" name="_eventId_customerInfoCollected" />
